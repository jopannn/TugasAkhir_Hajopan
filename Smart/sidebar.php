...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
            <!-- <li role="presentation"><a href="kriteria.php"><span class="fa fa-bank"></span> Kriteria</a></li>
            <li role="presentation"><a href="sub_kriteria.php"><span class="fa fa-book"></span> Sub Kriteria</a></li> -->
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
            <li role="presentation"><a href="perangkingan.php"><i class="fa fa-bar-chart" aria-hidden="true"></i> Rangking</a></li>
            <li role="presentation"><a href="laporan.php" target="_blank"><span class="fa fa-file-pdf-o"></span>Laporan</a></li>
        </ul>
    </div>
</div>
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
            <li role="presentation"><a href="login.php"><i class="fa fa-user" aria-hidden="true"></i> Login</a></li>
