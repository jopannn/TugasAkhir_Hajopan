...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
        <li role="presentation"><a href="kriteria.php"><span class="fa fa-book"></span> Alternatif</a></li>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
            <li role="presentation"><a href="../logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>
                    Logout</a></li>
